                    ...
                    <div class="col-12 col-lg-12 col-xl-12">
                        ...
                        <div class="flex-grow-0 py-3 px-4 border-top">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Digite sua mensagem" v-model="text" v-on:keyup.enter="sendMessage">
                                <button class="btn btn-primary" v-on:click="sendMessage" ><i class="fa fa-send" ></i></button>
                            </div>
                        </div>
...
export default {
  ...
  methods: {
    ...
    scroollToDown(){
        ...
        boardMessage.scrollTop = (boardMessage.scrollHeight - boardMessage.clientHeight);
    }
  },
  mounted(){
